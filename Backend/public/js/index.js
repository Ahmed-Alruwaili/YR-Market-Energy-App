  ...
  $(document).ready(function(){
    ...
    $.get("https://yrenergymarket.firebaseapp.com/stateslist", function(response){
      ...
      $('#search-location').find('option').remove();
    ...
    $("#search-btn").on("click", function(e){
      ...
      var url = 'https://api.openweathermap.org/data/2.5/forecast?q=' + locationName + '&cnt=100&units=metric&APPID=908f958d6609dd37ee33114a87b81e1a';
